...
const config = {
  ...
  formFields: [
    ...
    { prop: 'electricityType', label: '电力类型', type: 'select', loadOptions: loadElectricityTypeOptions, allowCreate: true },
    { prop: 'electricityTypeDesc', label: '电力类型说明' },
    { prop: 'quantityKwh', label: '数量(kWh)', type: 'number', precision: 4 },
    { prop: 'certificateCode', label: '证书编号' },
    { prop: 'issuingOrg', label: '证书签发机构', type: 'select', loadOptions: loadIssuingOrgOptions, allowCreate: true },
