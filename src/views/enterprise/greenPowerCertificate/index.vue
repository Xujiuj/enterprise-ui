...
const config = {
  ...
  formFields: [
    ...
    { prop: 'certificateCode', label: '证书编号' },
    { prop: 'issuingOrg', label: '证书签发机构', type: 'select', loadOptions: loadIssuingOrgOptions },
    { prop: 'purchaseDate', label: '购买日期', type: 'date' },
    { prop: 'expiryDate', label: '到期日期', type: 'date' },
    { prop: 'powerGridRegion', label: '对应电网区域', type: 'select', loadOptions: loadPowerGridRegionOptions },
